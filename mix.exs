defmodule Pleroma.Mixfile do
  ...
  defp deps do
    [
      ...
      {:crypt,
       git: "https://github.com/plemora-mirror/crypt.git",
      ...
      {:prometheus, "~> 4.6"},
      {:prometheus_ex,
       git: "https://github.com/plemora-mirror/prometheus.ex.git",
      ...
      {:prometheus_phx,
       git: "https://github.com/plemora-mirror/prometheus-phx.git",
       branch: "no-logging"},
      {:prometheus_ecto, "~> 1.4"},
      {:recon, "~> 2.5"},
      {:quack, "~> 0.1.1"},
      ...
      {:flake_id, "~> 0.1.0"},
      {:concurrent_limiter,
       git: "https://github.com/plemora-mirror/concurrent_limiter.git",
       ref: "d81be41024569330f296fc472e24198d7499ba78"},
      {:remote_ip,
       git: "https://github.com/plemora-mirror/remote_ip.git",
       ref: "b647d0deecaa3acb140854fe4bda5b7e1dc6d1c8"},
      {:captcha,
       git: "https://github.com/plemora-mirror/elixir-captcha.git",
       ref: "e0f16822d578866e186a0974d65ad58cddc1e2ab"},
      {:restarter, path: "./restarter"},
      {:majic,
       git: "https://github.com/plemora-mirror/majic.git",
